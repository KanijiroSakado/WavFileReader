...
int WavFileReader::Read(unsigned char *buf, unsigned int count) {
	...
	while (leftToRead>0) {
		...
		if (leftToRead < gpBufCnt)readCnt = leftToRead * NumChannels;
...
int WavFileReader::Read(signed short *buf, unsigned int count) {
...
int WavFileReader::Read(int *buf, unsigned int count) {
...
int WavFileReader::Read(double *buf, unsigned int count) {
...
int WavFileReader::Read(float *buf, unsigned int count) {
...
int WavFileReader::ReadLR(unsigned char *bufL, unsigned char *bufR, unsigned int count) {
...
int WavFileReader::ReadLR(signed short *bufL, signed short *bufR, unsigned int count) {
...
int WavFileReader::ReadLR(int *bufL, int *bufR, unsigned int count) {
...
int WavFileReader::ReadLR(double *bufL, double *bufR, unsigned int count) {
...
int WavFileReader::ReadLR(float *bufL, float *bufR, unsigned int count) {
